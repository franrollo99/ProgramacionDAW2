...
<body>
    <h1>Ejercicios de la hoja 06</h1>

    <h3>Ejercicio 1</h3>
    <?php
        include 'claseVolador.php';
        include 'claseElementoVolador.php';
        include 'claseAvion.php';
        include 'claseHelicoptero.php';
        include 'claseAeropuerto.php';

        $comunicacionAeropuerto=new Aeropuerto();
        echo $comunicacionAeropuerto->mostrarMensaje("Mensaje de prueba de trait");
