...
class AnimalController extends Controller
{
    ...
    public function show(string $a)
    {
        foreach($this->animales as $animal){
            if(strtolower($animal['especie']) == $a){
